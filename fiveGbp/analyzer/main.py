...
queryData = colPuml.find_one({"_id": 1}, {"_id": 0, "nodealias": 1})
string = '{'
...
queryData = colPuml.find_one({"_id": 1}, {"_id": 0, "graph": 1})
puml_start_options = []
...
# display_filter
queryData = colWireshark.find_one({"_id": 1}, {"_id": 0, "filters": 1})
display_filter = ''
...
# decodeas
queryData = colWireshark.find_one({"_id": 1}, {"_id": 0, "decoders": 1})
string = '{'
...
# protocols
queryData = colWireshark.find_one({"_id": 1}, {"_id": 0, "protocols": 1})
protocols = []
